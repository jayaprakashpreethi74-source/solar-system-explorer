...
var Selection2 = class extends Set {
  /**
...
var GodRaysEffect = class extends Effect {
  ...
  constructor(camera, lightSource, {
    ...
    this.copyPass.fullscreenMaterial.channelWeights = new Vector4(0, 0, 0, 1);
...
function determinant3() {
  ...
  var a = terms[0], b = terms[1], c2 = terms[2], d = terms[3], e = terms[4], f = terms[5], g = terms[6], h = terms[7], i2 = terms[8];
  return a * e * i2 + b * f * g + c2 * d * h - c2 * e * g - b * d * i2 - a * f * h;
}
...
function normalize(x, y, z) {
  var m2 = Math.sqrt(x * x + y * y + z * z);
  return [x / m2, y / m2, z / m2];
}
...
function rotateVectorOnVector(a, b) {
  var v4 = new Vector3().crossVectors(a, b);
  var c2 = a.dot(b);
  var i2 = new Matrix3().identity();
  var vx = new Matrix3().set(0, -v4.z, v4.y, v4.z, 0, -v4.x, -v4.y, v4.x, 0);
...
function rotate(buffer2, rotation) {
  ...
  for (var _i5 = 0; _i5 < buffer2.length; _i5 += 3) {
    v4.set(buffer2[_i5] - center2[0], buffer2[_i5 + 1] - center2[1], buffer2[_i5 + 2] - center2[2]);
    v4.applyQuaternion(q);
    buffer2[_i5] = v4.x + center2[0];
    buffer2[_i5 + 1] = v4.y + center2[1];
    buffer2[_i5 + 2] = v4.z + center2[1];
  }
  return buffer2;
}
...
var seed = function seed2(_seed) {
  ...
  for (var i2 = 0; i2 < 256; i2++) {
    ...
    perm[i2] = perm[i2 + 256] = v4;
    gradP[i2] = gradP[i2 + 256] = grad3[v4 % 12];
  }
};
seed(0);
...
var perlin3 = function perlin32(x, y, z) {
  ...
  var v4 = fade(y);
  var w = fade(z);
  return lerp(lerp(lerp(n000, n100, u), lerp(n001, n101, u), w), lerp(lerp(n010, n110, u), lerp(n011, n111, u), w), v4);
};
...
var ASCIIEffect = class extends Effect {
  constructor({
    ...
    const uniforms = /* @__PURE__ */ new Map([
      ...
      ["uColor", new Uniform(new Color(color2))],
...
var ASCII = (0, import_react17.forwardRef)(
  ({
    ...
    const effect = (0, import_react17.useMemo)(
      () => new ASCIIEffect({ characters, font, fontSize, cellSize, color: color2, invert }),
      [characters, fontSize, cellSize, color2, invert, font]
    );
